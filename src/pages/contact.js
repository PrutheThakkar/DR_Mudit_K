...
const ContactPage = ({ data }) => {
  ...
  const banner = data?.allWpPage?.nodes?.[0]?.commonBannerImage;
  ...
  const handleSubmit = async (event) => {
    ...
    if (!webhookUrl) {
      setFormStatus("error");
      setFormMessage(
        "The appointment form is not configured yet. Please call or email us."
      );
      return;
    }
  ...
  return (
    <Layout>
      <InsideBanner
        ...
        highlightedTitle="Dr. Mudit Khanna"
        image={banner?.bannerImage?.node?.sourceUrl || contactHeroImage}
        imageAlt={
          banner?.bannerImage?.node?.altText || "Contact Dr. Mudit Khanna"
        }
        description={null}
      />
            ...
            <div className="contact-information-card">
              <div className="contact-information-card__content">
                <p className="contact-introduction">
                  Whether you&apos;re seeking relief from hip or knee pain,
                  exploring treatment options, or looking for a second opinion,
                  schedule a consultation with Dr. Mudit Khanna for personalised
                  orthopaedic care.
                </p>
                ...
                <address className="contact-address">
                  <div className="contact-address__item">
                    ...
                    <span>Wockhardt Hospital – Mumbai Central</span>
                  </div>
                  ...
                  <div className="contact-address__item">
                    ...
                    <a href="tel:+918657790513">+91 86577 90513</a>
                  </div>
                </address>
...
export const Head = ({ location }) => (
  <SEO
    title="Contact Dr. Mudit Khanna | Book an Appointment"
    description="Contact Dr. Mudit Khanna for personalised hip and knee treatment, second opinions and orthopaedic consultations in Mumbai."
